    ...
    <div id="conteneur">
        <div class=column_A>
            ...
            <script type="text/javascript">
                function afficheGrandePhoto2(imageCliquee2) {
                    /* je récupère dans l'attribut alt de l'image cliquée son nom */
                    console.log("afficheGrandePhoto2 : " + imageCliquee2.alt);
                    /* URL de la vignette cliquée ? */
                    var URLvignette2 = imageCliquee2.getAttribute("src");
                    console.log("URL de la photo cliquée : " + URLvignette2);
                    ...
                    var grandePhoto2 = document.querySelector("#grandephoto2 img");
                    grandePhoto2.setAttribute("src", URLvignette2);
                    grandePhoto2.setAttribute("alt", imageCliquee2.alt);
                }
            </script>
            </div>
            <div id="global">
                ...
                <section id="vignettes">
                    <ul>
                        <?php
                        foreach ($slider2 as $item2) {
                            ?>


                            <li><img src="<?=$item2['image'];?>" alt="" width="128" height="96" onclick="afficheGrandePhoto2(this);" /></li>
                        <?php } ?>
