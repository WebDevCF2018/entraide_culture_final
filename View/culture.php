    ...
    <div id="conteneur">
        <div class=column_A>
            ...
            <script type="text/javascript">
                function afficheGrandePhoto3(imageCliquee3) {
                    /* je récupère dans l'attribut alt de l'image cliquée son nom */
                    console.log("afficheGrandePhoto : " + imageCliquee3.alt);
                    /* URL de la vignette cliquée ? */
                    var URLvignette3 = imageCliquee3.getAttribute("src");
                    console.log("URL de la photo cliquée : " + URLvignette3);
                    ...
                    var grandePhoto3 = document.querySelector("#grandephoto3 img");
                    grandePhoto3.setAttribute("src", URLvignette3);
                    grandePhoto3.setAttribute("alt", imageCliquee3.alt);
                }
            </script>
            <div id="global">
                <section>
                ...
                <section id="vignettes">
                    <ul>
                        <?php
                        foreach ($slider3 as $item3) {
                            ?>


                            <li><img src="<?=$item3['image'];?>" alt="" width="128" height="96" onclick="afficheGrandePhoto3(this);" /></li>
                        <?php } ?>
