<div class="panel" data-x-pos="1"  data-y-pos="1">
    ...
    <div id="conteneur">
        <div class=column_A>
            <div class=zoom>
                <div class="col-lg-1 padbot30 gallery_img lorem" id="grandephoto4">
    ...
    height: 100%;" /></a>
            ...
            <script type="text/javascript">
                function afficheGrandePhoto4(imageCliquee4) {
                    /* je récupère dans l'attribut alt de l'image cliquée son nom */
                    console.log("afficheGrandePhoto : " + imageCliquee4.alt);
                    /* URL de la vignette cliquée ? */
                    var URLvignette4 = imageCliquee4.getAttribute("src");
                    console.log("URL de la photo cliquée : " + URLvignette4);
                    ...
                    var grandePhoto4 = document.querySelector("#grandephoto4 img");
                    grandePhoto4.setAttribute("src", URLvignette4);
                    grandePhoto4.setAttribute("alt", imageCliquee4.alt);
                }
            </script>
            <div id="global">
                <section>
                ...
                <section id="vignettes">
                    <ul>
                        <?php
                        foreach ($slider5 as $item0) {
                            ?>


                            <li><img src="<?=$item0['image'];?>" alt="" width="128" height="96" onclick="afficheGrandePhoto4(this);" /></li>
                        <?php } ?>
